          ...
          <div class="box-content">
            ...
            <el-row>
              ...
              <el-col :span="4"
                ><div class="grid-content bg-purple-light">
                  <span class="value"
                    >{{ opdata[0].age }}{{ opdata[0].specific_age }}</span
                  >
                </div></el-col
              >
            </el-row>
...
>>>>>>> 4e03505e1218afb920386f510129188a9ee4e284
                  <el-col :span="20" :push="1"
                    ><div class="grid-content bg-purple">
                      ...
                      <span
                        class="label"
                        v-show="checkstate == 6 || checkstate == 10"
                        >情况说明:</span
                      >
                      <span class="label" v-show="checkstate == 7"
                        >处理意见:</span
                      >
                      <span
                        class="label"
                        v-show="checkstate == 8 || checkstate == 9"
                        >事实及理由:</span
                      >
                      <el-input
                        type="textarea"
...
>>>>>>> 4e03505e1218afb920386f510129188a9ee4e284
        ...
        <div class="box-button">
          <slot name="submit">
            ...
            <el-button
              type="primary"
              v-show="checkstate == 11 || checkstate == 1"
              @click="issuesss()"
              >下发</el-button
            >
            <el-button type="primary" @click="send()" v-show="checkstate == -2"
              >退回</el-button
            >
            <el-button
              type="primary"
...
<<<<<<< HEAD
    ...
    upfilesubmit() {
      ...
      this.getBase64(this.file.raw).then((res) => {
        ...
        //科室自查   科室改进
        if (
          this.$parent.opdata[0].state.state_val == 1 ||
          this.$parent.opdata[0].state.state_val == 11
        ) {
          let params = {
