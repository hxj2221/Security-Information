    ...
    <div class="operation" style="min-height: 800px" v-if="operationdata!=''&&opdata!=''">
      <div class="operation-top">
        ...
        <div style="display:flex">
          <slot name="records">
            <el-button type="primary" icon="el-icon-edit" class="records" @click="records">医患记录</el-button>
          </slot>
          <slot name="detail">
            <el-button type="primary" icon="el-icon-s-order" class="detail" slot="reference" @click="drawer = true">投诉详情
            </el-button>
          </slot>
          <slot name="back">
            <el-button type="primary" icon="iconfont el-icon-hospital-passwordai207" class="return"
              style="border: 1px solid #949aef">返回</el-button>
          </slot>
        </div>
      </div>
      <slot name='drawerss'>
      ...
      <bscroll>
        <div class="operation-content">
          ...
          <div class="box-Information">
            ...
            <div class="box-content">
              ...
              <div style="border-bottom: 0.5px solid #e0e2fa; width: 100%; margin-bottom: 20px"></div>
            </div>
          </div>
                  ...
                  <el-col :span="6" :push="1">
                    <div class="grid-content bg-purple">
                      ...
                      <el-select v-model="peopel" multiple placeholder="请选择" clearable>
                        <el-option v-for="item in opdata[1].user" :key="item.id" :label="item.name" :value="item.id">
                        </el-option>
                      </el-select>
                    </div>
                  </el-col>
                ...
                <el-row type="flex" class="row-bg" justify="space-between">
                  <el-col :span="20" :push="1">
                    <div class="grid-content bg-purple">
                      ...
                      <el-input type="textarea" v-model="treatment" :autosize="{ minRows: 2, maxRows: 4}"
                        placeholder="请填写" maxlength="200"></el-input>
                    </div>
                  </el-col>
                </el-row>
                <el-row type="flex" class="row-bg" justify="space-between">
                  <el-col :span="20" :push="1">
                    <div class="grid-content bg-purple">
                      ...
                      <el-input type="textarea" v-model="response" maxlength="200" placeholder="请填写"
                    ...
                    <el-col :span="2" :pull="1">
                      <div class="grid-content bg-purple">
                        <el-button type="primary" icon="el-icon-circle-plus" @click="upfile()"
                          style="background-color: #666ee8; border: none">上传附件</el-button>
                      </div>
                    </el-col>
                  </el-row>
                  <el-row type="flex" class="row-bg" justify="space-between">
                    <el-col :span="22" :push="1">
                      <div class="grid-content bg-purple">
                        <el-table :data="fileList" style="width: 100%" :header-cell-style="getRowClass">
                          <el-table-column type="index" width="50" label="序号"></el-table-column>
                          <el-table-column prop="file_name" label="文件名" width="width">
                          </el-table-column>
                          <el-table-column prop="represent" label="描述" width="width">
                          </el-table-column>
                          <el-table-column prop="username.name" label="提交人" width="width">
                          </el-table-column>
                          <el-table-column prop="create_time" label="上传时间" width="width">
                          </el-table-column>
                          <el-table-column prop="file_size" label="文件大小" width="width">
                          </el-table-column>
                ...
                <el-row type="flex" class="row-bg" justify="space-between">
                  <el-col :span="20" :push="1">
                    <div class="grid-content bg-purple">
                      ...
                      <el-input type="textarea" v-model="analysis" maxlength="200" placeholder="请填写"
                        :autosize="{ minRows: 2, maxRows: 4}"></el-input>
                    </div>
                  </el-col>
                </el-row>
                <el-row type="flex" class="row-bg" justify="space-between">
                  <el-col :span="20" :push="1">
                    <div class="grid-content bg-purple">
                      ...
                      <el-input type="textarea" v-model="responsibility" placeholder="请填写" maxlength="200"
                        :autosize="{ minRows: 2, maxRows: 4}"></el-input>
                    </div>
                  </el-col>
                </el-row>
                <el-row type="flex" class="row-bg" justify="space-between">
                  <el-col :span="20" :push="1">
                    <div class="grid-content bg-purple">
                      ...
                      <el-input type="textarea" v-model="measures" maxlength="200" placeholder="请填写"
                        :autosize="{ minRows: 2, maxRows: 4}"></el-input>
                    </div>
                  </el-col>
                </el-row>
            ...
            <div class="feedback-content">
              ...
              <div>
                  ...
                  <el-col :span="6" :push="1">
                    <div class="grid-content bg-purple">
                      ...
                      <el-select v-model="checkstate" placeholder="请选择事件状态" @change="changestate" clearable>
                        <el-option v-for="item in opdata[1].examine" :key="item.state_val" :label="item.title"
                  ...
                  <el-row type="flex" class="row-bg" justify="space-between">
                    <el-col :span="20" :push="1">
                      <div class="grid-content bg-purple">
                        ...
                        <el-input type="textarea" v-model="preliminary" placeholder="请填写" maxlength="200"
                          :autosize="{ minRows: 2, maxRows: 4}"></el-input>
                      </div>
                    </el-col>
                  </el-row>
                  ...
                  <el-row type="flex" class="row-bg" justify="space-between" style="margin-top:10px">
                    <el-col :span="6" :push="1">
                      <div class="grid-content bg-purple">
                        ...
                        <br />
                        <el-cascader ref="cascader" :options="opdata[1].department" :props="{
                          value: 'id',
                          label: 'title',
                          children: '_child',
                          multiple: 'true',
                        }" :show-all-levels="false" v-model="comde" clearable collapse-tags style="margin-left: 10px">
                        </el-cascader>
                      </div>
                    </el-col>
                  </el-row>
               ...
               onkeypress="return( /[\d]/.test(String.fromCharCode(event.keyCode) ) )"
                        ...
                        autosize
                      ></el-input>-->
                        <el-date-picker :picker-options="pickerOptions" style="margin-left: 10px" v-model="needtime"
                  ...
                  <el-row type="flex" class="row-bg" justify="space-between">
                    <el-col :span="20" :push="1">
                      <div class="grid-content bg-purple">
                        ...
                        <el-input type="textarea" v-model="facts" placeholder="请填写" maxlength="200"
                          :autosize="{ minRows: 2, maxRows: 4}"></el-input>
                      </div>
                    </el-col>
                  </el-row>
                  <el-row type="flex" class="row-bg" justify="space-between">
                    <el-col :span="20" :push="1">
                      <div class="grid-content bg-purple">
                        ...
                        <el-input type="textarea" v-model="focus" maxlength="200" placeholder="请填写"
                          :autosize="{ minRows: 2, maxRows: 4}"></el-input>
                      </div>
                    </el-col>
                  </el-row>
                  ...
                  <el-row type="flex" class="row-bg" justify="space-between" v-if="checkstate !== 4">
                    <el-col :span="6" :push="1">
                      ...
                      ></el-input>
                       -->
                        <br />
                        <el-date-picker :picker-options="pickerOptions" style="margin-left: 10px" v-model="date"
                          type="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="timestamp">
                        </el-date-picker>
                      </div>
                    </el-col>
                  </el-row>
                ...
                ">
                    <el-col :span="20" :push="1">
                      <div class="grid-content bg-purple">
                        ...
                        <span class="label" v-show="checkstate == 6 || checkstate == 10">情况说明:</span>
                        <span class="label" v-show="checkstate == 7">处理意见:</span>
                        <span class="label" v-show="checkstate == 8 || checkstate == 9">事实及理由:</span>
                        <el-input type="textarea" maxlength="200" v-model="preliminary" placeholder="请填写"
                          :autosize="{ minRows: 2, maxRows: 4}"></el-input>
                      </div>
                    </el-col>
                  </el-row>
                    ...
                    <el-col :span="6" :push="1">
                      <div class="grid-content bg-purple">
                        ...
                        <el-cascader ref="cascader" :options="opdata[1].department" :props="{
                          ...
                          children: '_child',
                          multiple: 'true',
                        }" :show-all-levels="false" v-model="comde" collapse-tags style="margin-left: 10px" clearabl>
                        </el-cascader>
                      </div>
                    </el-col>
                  </el-row>
                  ...
                  <el-row type="flex" class="row-bg" justify="space-between">
                    <el-col :span="20" :push="1">
                      <div class="grid-content bg-purple">
                        ...
                        <el-input type="textarea" v-model="preliminary" maxlength="200" placeholder="请填写"
                          :autosize="{ minRows: 2, maxRows: 4}"></el-input>
                      </div>
                    </el-col>
                  </el-row>
                  <el-row type="flex" class="row-bg" justify="space-between">
                    <el-col :span="20" :push="1">
                      <div class="grid-content bg-purple">
                        ...
                        <el-input type="textarea" v-model="management" maxlength="200" placeholder="请填写"
                          :autosize="{ minRows: 2, maxRows: 4}"></el-input>
                      </div>
                    </el-col>
                  </el-row>
                  ...
                  <el-row type="flex" class="row-bg" justify="space-between">
                    <el-col :span="6" :push="1">
                      <div class="grid-content bg-purple">
                        ...
                        <br />
                        <el-cascader ref="cascader" placeholder="请选择投诉类别" :options="opdata[1].event_type" :props="{
                          value: 'id',
                          label: 'title',
                          multiple: 'true'}" :show-all-levels="false" v-model="eventtype" clearabl
                  ...
                  <el-row type="flex" class="row-bg" justify="space-between">
                    <el-col :span="6" :push="1">
                      <div class="grid-content bg-purple">
                        ...
                        <br />
                        <el-cascader ref="cascader" placeholder="请选择责任度" :options="accountabilitylist" :props="{
                          value: 'id',
                          label: 'title',
                          multiple: 'true'}" :show-all-levels="false" v-model="accountability" clearable
                          style="margin-left:10px"></el-cascader>
                      </div>
                    </el-col>
                  </el-row>
                  <el-row type="flex" class="row-bg" justify="space-between">
                    <el-col :span="20" :push="1">
                      <div class="grid-content bg-purple">
                        ...
                        <el-input type="textarea" v-model="economic" placeholder="请填写" maxlength="200"
                          :autosize="{ minRows: 2, maxRows: 4}"></el-input>
                      </div>
                    </el-col>
                  </el-row>
              ...
              <div class="box-feedback" v-if="checkstate == -1 || checkstate == -2|| checkstate == 1">
                <div class="box-top">
                  <el-row type="flex" class="row-bg" justify="space-between">
                    <el-col :span="7" :push="1">
                      <div class="grid-content bg-purple">
                ...
                <div class="feedback-content">
                  ...
                  <el-row type="flex" class="row-bg" justify="space-between" style="margin-left: 10px">
                    <el-col :span="10" :push="1">
                      <div class="grid-content bg-purple">
                        <span class="label">经办人姓名:</span>
                        <el-input type="input" v-model="agentname" maxlength="3" placeholder="请填写" autosize></el-input>
                      </div>
                    </el-col>
                  </el-row>
                  <el-row type="flex" class="row-bg" justify="space-between" style="margin-left: 10px">
                    <el-col :span="10" :push="1">
                      <div class="grid-content bg-purple">
                        ...
                        <el-input type="input" v-model="agentphone" placeholder="请填写" maxlength="11"
                          oninput="value=value.replace(/[^\d]/g,'')"
                          onkeypress="return( /[\d]/.test(String.fromCharCode(event.keyCode) ) )" autosize></el-input>
                      </div>
                    </el-col>
                  </el-row>
                </div>
          ...
          <div class="box-button">
            <slot name="submit">
              <el-button type="primary" @click="submit()" icon="el-icon-finished"
                v-show="checkstate !== -2 && checkstate !== -1&&checkstate !== 11&&checkstate !== 1||operationdata.state.state_val==11">
                确认提交</el-button>
        ...
        <!-- 上传文件弹窗 -->
        <div class="upfile">
          <el-dialog title="上传文件" :visible.sync="upfiles" width="30%" style="margin-top: 8%" :before-close="Close">
            <el-form ref="form" label-width="90px">
              <el-form-item label="文件标题：">
                <el-input v-model="filetitle" placeholder="请输入文件标题"></el-input>
              </el-form-item>
              <el-form-item label="文件描述：">
                <el-input type="textarea" v-model="filedescribe" maxlength="50" placeholder="请输入文件描述"
                  :autosize="{ minRows: 2, maxRows: 2}" style="max-heiht:100px"></el-input>
              </el-form-item>

              <el-form-item label="上传附件：" class="uploadfile">
                <el-upload action='http://bt1.wlqqlp.com:8082/index.php/api/srk/create_base64_file' class="upload-demo"
                  :limit='1' :disabled='(filetitle==""||filedescribe=="")?true:false' :multiple='false'
                  :file-list='listsss' :on-change="handleChange" :on-exceed='exceed' :auto-upload="false">
                  <el-button slot="trigger" size="small" type="primary"
                    :disabled='(filetitle==""||filedescribe=="")?true:false'>选取文件</el-button>
            ...
            <span slot="footer" class="dialog-footer">
              ...
              <el-button type="primary" @click="upfilesubmit" :disabled='(filetitle==""||filedescribe=="")?true:false'>确
                定
              </el-button>
            </span>
          </el-dialog>
    ...
    methods: {
      ...
      records() {
        ...
        this.$router.push({
          path: '/Connect',
          query: {
            event_number: this.$parent.opdata[0].event_number
          }
        })
      },
      //关闭上传文件弹窗
