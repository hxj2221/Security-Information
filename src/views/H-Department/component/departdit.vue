<template>
  <div class="departAll">
    ...
    <div class="departaddThre">
      ...
      <div>
        <el-button class="departaddgr" icon="iconfont el-icon-hospital-passwordbaocun" @click="departeditvueyes">保存
        </el-button>
        <el-button class="departaddb" icon="iconfont el-icon-hospital-passwordai207" @click="departeditvueno">返回
        </el-button>
      </div>
    </div>
    <div class="addmain">
        ...
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item label="科室编号" disabled>
              <el-input type="input" autosize v-model="ksnum" disabled placeholder="10001"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="科室名称" required>
              <el-input type="input" autosize v-model="departNameipt"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
