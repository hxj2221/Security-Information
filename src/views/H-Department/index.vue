  ...
  <div>
    <div class="departalBg" v-if="departvue">
      ...
      <el-table :data="dormitory" class="departtable" max-height="662"
        ...
        <el-table-column prop="createname.name" label="创建人员"></el-table-column>
        ...
        <el-table-column fixed="right" label="操作">
          <template slot-scope="scope">
            <el-button class="departEdit" type="text" size="small" @click="handleEdit(scope.row.id)">编辑</el-button>
            <el-button class="departDel" size="small" type="text" @click="handleDelete(scope.row.id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
