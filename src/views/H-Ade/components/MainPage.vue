<template>
  <div class="mainBl">
    ...
    <el-table class="elTable" :data="tableData">
      ...
      <el-table-column prop="serialNum" label="事件编码" width="130">
      </el-table-column>
      <el-table-column prop="name" label="患者姓名" width="130">
      </el-table-column>
      ...
      <el-table-column prop="place" label="发生场所" width="130">
      </el-table-column>
      <el-table-column prop="level" label="轻重程度" width="110">
      </el-table-column>
      <el-table-column prop="date1" label="上报时间" width="150">
      </el-table-column>
      <el-table-column prop="depart" label="患者科室" width="140">
      </el-table-column>
      <el-table-column prop="person" label="上报人" width="140">
      </el-table-column>
