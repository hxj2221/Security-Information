<template>
  <div class="addAll">
          ...
          <el-table class="info" :data="tableData" :header-cell-style="getRowClass">
            ...
            <el-table-column label="操作" fixed="right">
              <template slot-scope="scope">
                <el-button style="color:#666ee8" @click="handleClick(scope.row)" type="text" size="small">取消关联
                </el-button>
              </template>
            </el-table-column>
          </el-table>
    ...
    <!-- 底部按钮 -->
    <div class="root">
      <el-button type="primary" size="medium" class="AdeSure" icon="iconfont el-icon-hospital-passwordbaocun"
        @click="sure">提交
      </el-button>
      <el-button type="primary" size="medium" class="AdeBack" icon="iconfont el-icon-hospital-passwordai207"
        @click="back">返回
      </el-button>
    </div>
  </div>
...
import bscroll from '@/components/better-scroll/bscroll'
  export default {
    ...
    created() {
      ...
      //   if (res.cede == 20010) {
      //     this.addAde.event_num=res.event_num
