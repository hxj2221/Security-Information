  ...
  <div class="connent_all">
    ...
    <div class="connent_top">
      ...
      <div class="connent_top_right">
        ...
        <el-button type="primary" size="medium" icon="iconfont el-icon-hospital-passwordexport" @click="exportcom">导出
        </el-button>
      </div>
    </div>
    <!-- <hr class="connent_hr" /> -->
    ...
    <div class="connent_Tableall">
      ...
      <div class="connent_myTable">
        ...
        <el-table :data="tableData" max-height="545" :header-cell-style="getRowClass">
          ...
          <el-table-column label="记录编号" prop="number" width="150">
          </el-table-column>
          ...
          <el-table-column fixed="right" label="操作" width="200">
            <template slot-scope="scope">
              ...
              <el-button style="color: #666ee8" type="text" size="small" @click="complaint(scope.$index, scope.row)">
                投诉详情
              </el-button>
