  ...
  <div class="addRecord_all">
        ...
        <el-dialog title="上传文件" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
          <div class="addRecord_enclosure_dialog_div">
            <el-form ref="form" :model="dialogForm">
              ...
              <el-form-item>
                <el-upload :headers="myHeaders" class="upload-demo" :action="imgUrl" multiple :limit="3"
                  :on-exceed="handleExceed" :file-list="fileList" :http-request="getFile">
    ...
    <div class="addRecord_relation">
      ...
      <div class="addRecord_relation_content">
        ...
        <el-button type="primary" icon="el-icon-circle-plus">添加投诉信息</el-button>
      </div>
    </div>
    <!-- 固定定位按钮 -->
    <div class="addRecord_button">
      <div class="button_stlye">
      <el-button type="primary" icon="iconfont el-icon-hospital-passwordbaocun" @click="mysubmit">提交
      </el-button>
      <el-button type="primary" icon="iconfont el-icon-hospital-passwordai207" @click="mySubmit">返回
      </el-button>
      </div>
    </div>
  </div>
