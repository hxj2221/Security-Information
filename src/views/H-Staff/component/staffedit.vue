          ...
          <el-col :span="6">
            <div class="grid-content bg-purple">
              <el-form-item label="性别" required>
                <el-select class="dialog-input-text" type="input" autosize v-model="addStaff.sex" placeholder="请选择">
        ...
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item class="ssks" label="所属科室" required>
              <el-select class="dialog-input-text" type="input" autosize v-model="department_id" placeholder="请选择">
          ...
          <el-col :span="6">
            <el-form-item label="角色" required>
              <el-select class="dialog-input-text" type="input" autosize v-model="addStaff.auth_grouap"
                placeholder="请选择" @change="departsel">
        ...
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item label="密码" required>
              <el-input class="dialog-input-text" type="password" v-model="addStaff.password" placeholder="******">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
